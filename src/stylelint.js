export default {
  ...
  rules: {
    "at-rule-allowed-list": ["import", "media", "keyframes", "each", "font-face", "use"],
    ...
    "declaration-property-value-allowed-list": [
      {
        ...
        color: ["/^var/", "/^v-bind/"],
        "background-color": ["/^var/", "/^v-bind/"],
        "border-color": ["/^var/", "/^v-bind/"],
      },
    ],
    ...
    "media-feature-name-value-allowed-list": [{ "max-width": ["$mobile", "$tablet", "$notebook"] }],
